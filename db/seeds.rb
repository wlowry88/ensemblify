...
Instrument.create([{name:"violin"},{name: "viola"},{name: "cello"},{name: "bass"},{name: "harp"},{name: "guitar"},{name: "flute"},{name: "clarinet"},{name: "oboe"},{name: "bassoon"},{name: "french horn"},{name: "trumpet"},{name: "trombone"},{name: "tuba"},{name: "piano"},{name: "voice"},{name: "percussion"},{name: "saxophone"}])
